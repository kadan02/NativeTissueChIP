...
with open('../data/processed/classification/mistral-small31-24b_full/native_classified.tsv', mode='r', encoding='utf-8', ) as tsv_file:
...
output_files = {}
try:
    with open("../data/raw/bed/Oth.Utr.05.AllAg.AllCell.bed", 'r', encoding="UTF-8") as input_file:
