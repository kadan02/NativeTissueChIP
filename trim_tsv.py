...
def trim_table(input_tsv, output_tsv, variable_names):
    ...
    # TODO: később beépíteni a filter_native_tissues.py scriptbe ezt a functiont, hogy ne kelljen külön lefuttatni
    """
...
input_path = 'tsv/cellosaurus_test/mm10_native_runs.tsv'
output_path = 'tsv/cellosaurus_test/mm10_native_runs_less_col_trimmed.tsv'
